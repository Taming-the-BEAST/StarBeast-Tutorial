...
\begin{figure}[h]
\centering
\includeimage[scale=0.4,clip=true,trim=0 600 200 0]{figures/BEAUti_selectTemplate}
...
\begin{figure}[h]
\centering
\includeimage[scale=0.4,clip=true,trim=0 650 0 0]{figures/BEAUti_DataPartitions}
...
\begin{figure}[h]
\centering
\includeimage[width=0.9\textwidth]{figures/BEAUti_Guess_Taxonsets}
...
\begin{figure}[h]
\centering
\includeimage[width=0.9\textwidth,clip=true,trim=0 550 0 0]{figures/BEAUti_Site_Model}
...
\begin{figure}[h]
\centering
\includeimage[scale=0.4,clip=true,trim=0 700 0 0]{figures/BEAUti_ClockModel1}
\centering
\includeimage[scale=0.4,clip=true,trim=0 700 0 0]{figures/BEAUti_ClockModel2}
\centering
\includeimage[scale=0.4,clip=true,trim=0 700 0 0]{figures/BEAUti_ClockModel3}
...
\begin{figure}[h]
\centering
\includeimage[scale=0.4,clip=true,trim=0 400 0 0]{figures/BEAUti_MSP}
...
\begin{figure}[h]
\centering
\includeimage[scale=0.35,clip=true]{figures/BEAUti_settingPriors}
...
\bigskip
\href{http://creativecommons.org/licenses/by/4.0/}{\includegraphics[scale=0.8]{figures/ccby.pdf}} This tutorial was written by Chi Zhang for \href{https://taming-the-beast.github.io}{Taming the BEAST} and is licensed under a \href{http://creativecommons.org/licenses/by/4.0/}{Creative Commons Attribution 4.0 International License}. 
